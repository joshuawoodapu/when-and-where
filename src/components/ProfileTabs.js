...
class Tabs extends Component {
    ...
    getCustomActivityData() {
     const result = [];
     for (var key in this.props.user.customActivities) {
         // skiping if prototype
         if (!this.props.user.customActivities.hasOwnProperty(key)) continue;

         var obj = this.props.user.customActivities[key];
